...
global.caption = "*©𝟐𝟎𝟐𝟒 FAVOR MD 𝐕𝟓*"; // Input Yours custom...(Maintain font for Flow)
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "256761396309", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "BABYFX", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "BABYFX", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "FAVOR-𝐌𝐃💜", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "FAVOR", // Input Yours custom...(Maintain font for Flow)
